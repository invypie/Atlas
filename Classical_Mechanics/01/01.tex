...
\phantomsection\label{anchor:1.1} By a well-known theorem of vector analysis, a necessary and sufficient condition that the work, \(W_{12}\), be independent of the physical path taken by the particle is that \(\symbf{F}\) be the gradient of some scalar function of position:
\begin{equation}
